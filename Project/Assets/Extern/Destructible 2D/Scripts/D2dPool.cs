...
namespace Destructible2D
{
	...
	// var foo = D2dPool<Foo>.Spawn() ?? new Foo();
	// D2dPool<Foo>.Despawn(foo);
	public static class D2dPool<T>
		where T : class
	{
		...
		// NOTE: Because it can return null, you should use it like this: D2dPool<Whatever>.Spawn(...) ?? new Whatever(...)
